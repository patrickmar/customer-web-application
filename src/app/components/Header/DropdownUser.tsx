...
const DropdownUser = (props: Props) => {
  const { dispatch, logoutUser } = props;
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li>
            <Link
              href="/profile"
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-red-600lg:text-base"
            >
              <svg
        ...
        <button
          className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-red-600lg:text-base"
          onClick={logoutUser}
        >
          <svg
            className="fill-current"
