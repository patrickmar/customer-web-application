                  ...
                  <form className="flex items-center">
                    ...
                    <div className="relative w-full">
                      ...
                      <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                      />
                    </div>
                  </form>
                </div>
                  ...
                  >
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <div className="flex items-center space-x-3">
                        <a
                          href="#"
                          className="flex items-center text-sm font-medium text-red-600 dark:text-red-500 hover:underline"
                        >
                          Save view
                        </a>
                        <a
                    ...
                    <div className="pt-3 pb-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                          ...
                          <ul className="space-y-2">
                            <li className="flex items-center">
                              <input
                                ...
                                type="checkbox"
                                value=""
                                className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-red-600 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                              />
                              <label
                                htmlFor="apple"
                        ...
                        <div className="py-2 space-y-2 font-light border-b border-gray-200 dark:border-gray-600">
                          <div className="flex items-center">
                            <input
                              ...
                              value=""
                              name="rating"
                              className="w-4 h-4 bg-gray-100 border-gray-300 text-red-600 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                            />
                            <label
                              htmlFor="five-stars"
                      ...
                      >
                        <td className="p-4 w-4">
                          <div className="flex items-center">
                            ...
                            >
                              <BiCreditCard
                                className={`w-5 h-5 text-[#007649] dark:text-[#B0F2D9]`}
                              />
                            </span>
                          </div>
                        </td>
                ...
                <ul className="inline-flex items-stretch -space-x-px">
                  ...
                  <li>
                    <a
                      href="#"
                      aria-current="page"
                      className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-red-600 bg-red-50 border border-primary-300 hover:bg-primary-100 hover:text-primary-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
                    >
                      3
                    </a>
                  </li>
